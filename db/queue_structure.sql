...
CREATE TABLE IF NOT EXISTS "notification_templates" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "key" varchar NOT NULL, "subject" varchar NOT NULL, "body" text NOT NULL, "channel" varchar DEFAULT 'email' NOT NULL, "active" boolean DEFAULT TRUE NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
