...
// import TableAvatar from "./components/site/table-avatar.js";

// document.addEventListener("turbo:load", () => {
//   // console.log('----');
//   const divElement = document.querySelector("div#example");
