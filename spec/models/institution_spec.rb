...
RSpec.describe Institution, type: :model do
  ...
  describe '#search' do
    ...
    #     institution = create(:institution, name: 'Intituição')
    ...
    #     results_search = Institution.search('inst')
    #     expect(institution.name).to eq(results_search.first.name)
    #   end
    #
    #   it 'returns institution by search term' do
    #     institution = create(:institution, name: 'inst')
    #     results_search = Institution.search('Institui')
    #     expect(institution.name).to eq(results_search.first.name)
    #   end
    # end
    #
