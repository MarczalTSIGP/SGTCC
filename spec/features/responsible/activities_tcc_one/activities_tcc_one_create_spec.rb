...
describe 'Activity::create', type: :feature do
  ...
  before do
    ...
    visit new_responsible_calendar_activities_tcc_one_path(calendar_tcc_one)
  end
  ...
  describe '#create' do
    context 'when activity is valid', js: true do
      it 'create an activity with tcc 1' do
        ...
        expect(page).to have_current_path responsible_calendar_activities_tcc_one_index_path(
          calendar_tcc_one
        )
