...
describe 'Activity::index', type: :feature do
  describe '#index' do
    ...
    context 'when shows all activities with tcc 1 selected by calendar' do
      it 'shows all activities with tcc 1 selected by calendar', js: true do
        calendar = create(:calendar_tcc_one, semester: 1)
        create(:activity_tcc_one, calendar: calendar)
        second_calendar = create(:calendar_tcc_one, semester: 2)
        new_activity = create(:activity_tcc_one, calendar: second_calendar)
