...
describe 'Activity::update', type: :feature do
  ...
  describe '#update' do
    ...
    before do
      visit edit_responsible_calendar_activities_tcc_two_path(activity.calendar, activity.id)
    end
    ...
    context 'when data is valid', js: true do
      it 'updates the activity' do
        ...
        expect(page).to have_current_path responsible_calendar_activities_tcc_two_path(
